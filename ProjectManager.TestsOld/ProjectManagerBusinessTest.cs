...
namespace ProjectManager.Tests
{
    ...
    public class ProjectManagerBusinessTest
    {
        ...
        public void TestUpdateUser()
        {
            ...
            Assert.AreEqual(firstUser.FirstName, UpdateUser.FirstName);
            Assert.AreEqual(firstUser.LastName, UpdateUser.LastName);
            Assert.AreEqual(firstUser.EmployeeId, UpdateUser.EmployeeId);
        }
